              ...
              <section className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20 md:pt-28 md:pb-32 text-center flex flex-col items-center justify-center space-y-8 hero-gradient" id="landing_hero">
                ...
                <div className="animate-fadeInUp opacity-0 delay-200" style={{animationFillMode:'forwards'}}>
                  <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold text-white tracking-tight leading-[1.05] font-sans max-w-4xl" style={{fontFamily:'Syne, sans-serif'}}>
                    ...
                    <span className="text-shimmer">Instant Execution</span>
                  </h1>
                </div>
                ...
                <div className="animate-fadeInUp opacity-0 delay-500 pt-8 grid grid-cols-3 gap-8 border-t border-[#1F1F2E] max-w-sm w-full mx-auto" style={{animationFillMode:'forwards'}}>
                  ...
                  <div className="stat-card text-center delay-100">
                    <span className="block text-2xl sm:text-3xl font-black text-shimmer" style={{fontFamily:'Syne,sans-serif'}}>95%</span>
            ...
            <div className="relative shrink-0" id="dropdown_wrapper_cabinet">
              ...
              >
                ...
                <div className="text-right">
                  <span className="text-[9px] font-semibold text-gray-500 block leading-none tracking-wider">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <button
                      ...
                      className={`w-full text-left p-2.5 rounded-lg border transition-all flex items-center justify-between ${
                        accountType === "demo"
                          ? "bg-[#1e293b]/60 border-blue-500/60"
                    ...
                    >
                      ...
                      <span className="text-xs font-bold text-white font-mono">{formatCurrency(demoBalance)}</span>
                    </button>
                    ...
                    >
                      ...
                      <span className="text-xs font-bold text-white font-mono">{formatCurrency(liveBalance)}</span>
                    </button>
                  </div>
          ...
          <div className="flex-1 flex flex-row overflow-hidden relative" id="tadex_main_terminal_body">
            ...
            <div className="shrink-0 h-auto md:h-full w-full md:w-80 bg-[#0b1329] pt-1 pb-1.5 px-2.5 md:p-3 flex flex-col justify-start gap-2 md:gap-4 border-t md:border-t-0 border-[#22304a] overflow-visible z-40 relative" id="trade_panel_sidebar">
              ...
              <div className="space-y-1 md:space-y-3" id="controls_interior_root_v2">
                  ...
                  <div className="space-y-0.5 md:space-y-1" id="amount_field_widget">
                    ...
                    <div className="flex items-center bg-[#111827] border border-[#22304a]/75 rounded-xl p-0.5 md:p-1" id="amount_input_matrix">
                      ...
                      <div className="flex-1 text-center py-0.5">
                        <span className="block text-xs md:text-sm font-bold font-mono text-white leading-none">
                          ${tradeAmount}
                        </span>
                      </div>
                      <button
                ...
                {/* Active Call / Put buttons placed directly below and side-by-side with large dimensions */}
                <div className="grid grid-cols-2 gap-2 md:gap-2.5 pt-0.5 md:pt-1" id="order_actions_root">
                  
                  {/* Buy/Call button - 64px tall touch targets */}
                  <button
                    id="btn_order_buy"
                    onClick={() => handlePlaceTrade("buy")}
                    className="bg-[#22c55e] hover:bg-emerald-500 text-white rounded-xl active:scale-[0.98] transition-all cursor-pointer font-bold font-sans shadow-lg shadow-emerald-500/10 flex flex-col items-center justify-center h-[44px] md:h-[46px]"
                  >
                    <div className="flex items-center gap-1.5 justify-center leading-none">
                      <TrendingUp className="w-4 h-4 text-white" />
                      <span className="text-xs md:text-sm uppercase tracking-wider">UP</span>
                    </div>
                    <span className="text-[9px] font-mono text-emerald-100 uppercase font-normal mt-0.5 tracking-wider leading-none">BUY / CALL</span>
                  </button>

                  {/* Sell/Put button - 64px tall touch targets */}
                  <button
                    id="btn_order_sell"
                    onClick={() => handlePlaceTrade("sell")}
                    className="bg-[#ef4444] hover:bg-rose-500 text-white rounded-xl active:scale-[0.98] transition-all cursor-pointer font-bold font-sans shadow-lg shadow-rose-500/10 flex flex-col items-center justify-center h-[44px] md:h-[46px]"
                  >
                    <div className="flex items-center gap-1.5 justify-center leading-none">
                      <TrendingDown className="w-4 h-4 text-white" />
                      <span className="text-xs md:text-sm uppercase tracking-wider">DOWN</span>
                    </div>
                    <span className="text-[9px] font-mono text-rose-100 uppercase font-normal mt-0.5 tracking-wider leading-none">SELL / PUT</span>
                  </button>
                </div>
